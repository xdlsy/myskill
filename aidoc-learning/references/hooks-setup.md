    ...
    "UserPromptSubmit": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "~/.claude/skills/aidoc-learning/scripts/activator.sh"
          }
        ]
      }
    ]
...
```bash
./skills/aidoc-learning/scripts/extract-skill.sh test-skill --dry-run
```
...
```bash
chmod +x ./skills/aidoc-learning/scripts/activator.sh
chmod +x ./skills/aidoc-learning/scripts/error-detector.sh
chmod +x ./skills/aidoc-learning/scripts/extract-skill.sh
```
...
```json
{
  "command": "/absolute/path/to/skills/aidoc-learning/scripts/activator.sh"
}
```
