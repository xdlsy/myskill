...
infer_root_type() {
    ...
    case "$name" in
        ...
        internal|pkg|lib|libs|core|shared|common|packages) echo "private-lib" ;;
        test|tests|e2e|integration) echo "test" ;;
        docs|doc) echo "docs" ;;
        deploy|infra|infrastructure|terraform|k8s|ci|.github) echo "infrastructure" ;;
