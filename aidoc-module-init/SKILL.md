...
description: 为代码仓中所有叶子模块生成 AGENTS.md（每个 30-50 行）。依赖 .aidoc/phase0/repo-profile.md 中的画像数据。使用子代理并行生成。由 aidoc-build 阶段 2 触发，也可独立使用。
---
...
6. 在 `.aidoc/phase2/report.md` 中追加回查记录：
